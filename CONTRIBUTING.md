# Contributing to ReliaGrowR

This outlines how to propose a change to ReliaGrowR. For a detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("paulgovan/ReliaGrowR", fork = TRUE)`.
...
This project is in a stable state of development, with active subsequent
...
Code of
Conduct](https://paulgovan.github.io/ReliaGrowR/CODE_OF_CONDUCT.md). By
